...
"@
    ...
    # Write ASCII art and computer names to file
    $asciiArt | Out-File -FilePath $filePath
    "`nScanned Computers:" | Out-File -FilePath $filePath -Append
    $computerNames | Out-File -FilePath $filePath -Append

    Write-Host "Computer names and ASCII art header have been saved to $filePath" -ForegroundColor Green
} else {
