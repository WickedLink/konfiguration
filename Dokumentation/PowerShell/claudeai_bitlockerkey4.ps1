# Enhanced BitLocker Status Check Script v3.0
...
$computerListFile = "C:\inst\computerlist_hb_2.txt"
$outputFile = "C:\inst\bitlocker_results_hb_2.csv"
...
for ($i = 0; $i -lt $computersToCheck.Count; $i++) {
    ...
    if (Test-Connection -ComputerName $computer -Count 1 -Quiet) {
        ...
        if ($bitlockerInfo.BitLockerEnabled -eq $true) {
            ...
            Write-Host "    Computer SID: $($bitlockerInfo.ComputerSID)" -ForegroundColor Magenta
        } else {
            Write-Host "    BitLocker: " -NoNewline
